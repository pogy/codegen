...
package com.juntian.sifa.${system}${package}.manager.impl;
...
import com.juntian.sifa.${system}${package}.dao.${subtable.variables.class}Dao;
import com.juntian.sifa.${system}${package}.model.${subtable.variables.class};
</#list>
</#if>
import com.dstz.base.manager.impl.BaseManager;
import com.juntian.sifa.${system}${package}.dao.${class}Dao;
import com.juntian.sifa.${system}${package}.model.${class};
import com.juntian.sifa.${system}${package}.manager.${class}Manager;
/**
