...
<#assign type="com.juntian.sifa."+system+package+".model." +class>
...
<mapper namespace="com.juntian.sifa.${system}${package}.dao.${class}Dao">
	...
	<select id="getByMainId" resultMap="${class}">
	    SELECT *
	    FROM ${tableName} 
